...
public class GlobalProperties implements Serializable {
    ...
    public static ResourceBundle sanchayResourceBundle = ResourceBundle.getBundle("sanchay/intl/sanchay");
...
//    }
    ...
    public static ResourceBundle getResourceBundle()
    {
        if(sanchayResourceBundle == null)
            sanchayResourceBundle = ResourceBundle.getBundle("sanchay/intl/sanchay");
