 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class UserManagerServer extends SanchayServer
    implements UserManagerServerRI, Serializable
{
    private Hashtable users; // logged in users

    public UserManagerServer(PropertiesManager pm) throws RemoteException 
    {
        super(null, 0);
        
        propman = pm;
        users = new Hashtable(0, 3);
    }    

    public UserManagerServer(ActivationID id, MarshalledObject data)
